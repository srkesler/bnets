...
rng(1001); % Added by Vikram Rao on 02/05/2019 in order to fix the seed and have consistent results
...
for i=1:Nperm
    ...
    rng(1000+i); % Added by Vikram Rao on 02/05/2019 in order to fix the seed and have consistent results
    Samp1=randsample(Sz1+Sz2,Sz1,'true');
    rng(2000+i); % Added by Vikram Rao on 02/05/2019 in order to fix the seed and have consistent results
...
save(['Indiv_NetMesReg_' Group1],'MClust_1','MDeg_1','MNodeBetw_1','MLocEff_1','MPartCoeff_1','MClust_1norm','MDeg_1norm','MNodeBetw_1norm','MLocEff_1norm','MPartCoeff_1norm');
save(['Indiv_AUC_NetMesReg_' Group1],'AUC_MClust_1','AUC_MDeg_1','AUC_MNodeBetw_1','AUC_MLocEff_1','AUC_MClust_1norm','AUC_MDeg_1norm','AUC_MNodeBetw_1norm','AUC_MLocEff_1norm');
save(['Indiv_fda_NetMesReg_' Group1],'fda_MClust_1','fda_MDeg_1','fda_MNodeBetw_1','fda_MLocEff_1','fda_MClust_1norm','fda_MDeg_1norm','fda_MNodeBetw_1norm','fda_MLocEff_1norm');
...
save(['Indiv_NetMesReg_' Group2],'MClust_2','MDeg_2','MNodeBetw_2','MLocEff_2','MPartCoeff_2','MClust_2norm','MDeg_2norm','MNodeBetw_2norm','MLocEff_2norm','MPartCoeff_2norm');
save(['Indiv_AUC_NetMesReg_' Group2],'AUC_MClust_2','AUC_MDeg_2','AUC_MNodeBetw_2','AUC_MLocEff_2','AUC_MClust_2norm','AUC_MDeg_2norm','AUC_MNodeBetw_2norm','AUC_MLocEff_2norm');
save(['Indiv_fda_NetMesReg_' Group2],'fda_MClust_2','fda_MDeg_2','fda_MNodeBetw_2','fda_MLocEff_2','fda_MClust_2norm','fda_MDeg_2norm','fda_MNodeBetw_2norm','fda_MLocEff_2norm');
...
save(['NetMesReg_rand_' Group1],'MClust_1_rand','MDeg_1_rand','MNodeBetw_1_rand','MLocEff_1_rand','MClust_1_randnorm','MDeg_1_randnorm','MNodeBetw_1_randnorm','MLocEff_1_randnorm');
save(['NetMesReg_rand_' Group2],'MClust_2_rand','MDeg_2_rand','MNodeBetw_2_rand','MLocEff_2_rand','MClust_2_randnorm','MDeg_2_randnorm','MNodeBetw_2_randnorm','MLocEff_2_randnorm');
save(['AUC_NetMesReg_rand_' Group1],'AUC_MClust_1_rand','AUC_MDeg_1_rand','AUC_MNodeBetw_1_rand','AUC_MLocEff_1_rand','AUC_MClust_1_randnorm','AUC_MDeg_1_randnorm','AUC_MNodeBetw_1_randnorm','AUC_MLocEff_1_randnorm');
save(['AUC_NetMesReg_rand_' Group2],'AUC_MClust_2_rand','AUC_MDeg_2_rand','AUC_MNodeBetw_2_rand','AUC_MLocEff_2_rand','AUC_MClust_2_randnorm','AUC_MDeg_2_randnorm','AUC_MNodeBetw_2_randnorm','AUC_MLocEff_2_randnorm');
save(['fda_NetMesReg_rand_' Group1],'fda_MClust_1_rand','fda_MDeg_1_rand','fda_MNodeBetw_1_rand','fda_MLocEff_1_rand','fda_MClust_1_randnorm','fda_MDeg_1_randnorm','fda_MNodeBetw_1_randnorm','fda_MLocEff_1_randnorm');
save(['fda_NetMesReg_rand_' Group2],'fda_MClust_2_rand','fda_MDeg_2_rand','fda_MNodeBetw_2_rand','fda_MLocEff_2_rand','fda_MClust_2_randnorm','fda_MDeg_2_randnorm','fda_MNodeBetw_2_randnorm','fda_MLocEff_2_randnorm');

save(['NetMesReg_' Group1],'MClust_1','MDeg_1','MNodeBetw_1','MLocEff_1','MPartCoeff_1','MClust_1norm','MDeg_1norm','MNodeBetw_1norm','MLocEff_1norm','MPartCoeff_1norm');
save(['NetMesReg_' Group2],'MClust_2','MDeg_2','MNodeBetw_2','MLocEff_2','MPartCoeff_2','MClust_2norm','MDeg_2norm','MNodeBetw_2norm','MLocEff_2norm','MPartCoeff_2norm');
save(['AUC_NetMesReg_' Group1],'AUC_MClust_1','AUC_MDeg_1','AUC_MNodeBetw_1','AUC_MLocEff_1','AUC_MClust_1norm','AUC_MDeg_1norm','AUC_MNodeBetw_1norm','AUC_MLocEff_1norm');
save(['AUC_NetMesReg_' Group2],'AUC_MClust_2','AUC_MDeg_2','AUC_MNodeBetw_2','AUC_MLocEff_2','AUC_MClust_2norm','AUC_MDeg_2norm','AUC_MNodeBetw_2norm','AUC_MLocEff_2norm');
save(['fda_NetMesReg_' Group1],'fda_MClust_1','fda_MDeg_1','fda_MNodeBetw_1','fda_MLocEff_1','fda_MClust_1norm','fda_MDeg_1norm','fda_MNodeBetw_1norm','fda_MLocEff_1norm');
save(['fda_NetMesReg_' Group2],'fda_MClust_2','fda_MDeg_2','fda_MNodeBetw_2','fda_MLocEff_2','fda_MClust_2norm','fda_MDeg_2norm','fda_MNodeBetw_2norm','fda_MLocEff_2norm');
