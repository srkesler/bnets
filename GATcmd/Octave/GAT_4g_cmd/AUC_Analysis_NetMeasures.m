function AUC_Analysis_NetMeasures(data_log,NetM_1_2,NetM_2_3,NetM_1_3,NetM_1_4,NetM_2_4,NetM_3_4,MinThr,MaxThr)

%%
%-- updated on August 32,2011 for functionals
...
save NetMesPerDens_AveAcrossDens.mat -v7 Dens_1_rand MClust_1_rand MDeg_1_rand Trans_1_rand ...
...
save AUC_NetMesPerDens_AveAcrossDens.mat -v7  auc_MClust_1_rand auc_MDeg_1_rand auc_Trans_1_rand ...
...
AUC_indiv_mat(2:1+ff.mat4GAT.n1+ff.mat4GAT.n2,1:15)=AUC_indiv_mat(1:ff.mat4GAT.n1+ff.mat4GAT.n2,1:15);
AUC_indiv_mat(1,1:15)={'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn'};
save AUCdata.mat -v7 AUC_indiv_mat
xlswrite('AUCdata.xlsx',AUC_indiv_mat)
...
save AUC_Mean.mat-v7 auc_MClust_1_rand auc_MDeg_1_rand auc_Trans_1_rand ...
    auc_Assort_1_rand auc_GEff_1_rand auc_MLocEff_1_rand auc_Mod_1_rand auc_ModL_1_rand ...
    auc_PathL_1_rand auc_MNodeBetw_1_rand auc_MEdgeBetw_1_rand auc_Lambda_1_rand auc_Gamma_1_rand ...
    auc_Sigma_1_rand auc_MClust_2_rand auc_MDeg_2_rand auc_Trans_2_rand ...
    auc_Assort_2_rand auc_GEff_2_rand auc_MLocEff_2_rand auc_Mod_2_rand auc_ModL_2_rand ...
...
AUC_CLs_21(2:14,1:6)=AUC_CLs_21(1:13,1:6);
AUC_CLs_21(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable_21.mat -v7 AUC_CLs_21
xlswrite('AUCresultsTable_21.xlsx',AUC_CLs_21)
...
save NetMesPerDens_AveAcrossDens.mat -v7 Dens_2_rand MClust_2_rand MDeg_2_rand Trans_2_rand ...
    Assort_2_rand GEff_2_rand MLocEff_2_rand Mod_2_rand ModL_2_rand ...
    PathL_2_rand MNodeBetw_2_rand MEdgeBetw_2_rand Lambda_2_rand Gamma_2_rand ...
...
save AUC_NetMesPerDens_AveAcrossDens.mat -v7 auc_MClust_2_rand auc_MDeg_2_rand auc_Trans_2_rand ...
    auc_Assort_2_rand auc_GEff_2_rand auc_MLocEff_2_rand auc_Mod_2_rand auc_ModL_2_rand ...
    auc_PathL_2_rand auc_MNodeBetw_2_rand auc_MEdgeBetw_2_rand auc_Lambda_2_rand auc_Gamma_2_rand ...
...
AUC_indiv_mat(2:1+ff.mat4GAT.n2+ff.mat4GAT.n3,1:15)=AUC_indiv_mat(1:ff.mat4GAT.n2+ff.mat4GAT.n3,1:15);
AUC_indiv_mat(1,1:15)={'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn'};
save AUCdata.mat -v7 AUC_indiv_mat
xlswrite('AUCdata.xlsx',AUC_indiv_mat)
...
save AUC_Mean.mat -v7 auc_MClust_2_rand auc_MDeg_2_rand auc_Trans_2_rand ...
    auc_Assort_2_rand auc_GEff_2_rand auc_MLocEff_2_rand auc_Mod_2_rand auc_ModL_2_rand ...
    auc_PathL_2_rand auc_MNodeBetw_2_rand auc_MEdgeBetw_2_rand auc_Lambda_2_rand auc_Gamma_2_rand ...
...
AUC_CLs_32{2,5} = CL_Pval(auc_MDeg_3_rand - auc_MDeg_2_rand, auc_MDeg_3 - auc_MDeg_2,'AUC_MDeg',Tail);
...
AUC_CLs_32(2:14,1:6)=AUC_CLs_32(1:13,1:6);
AUC_CLs_32(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable_32.mat -v7 AUC_CLs_32
xlswrite('AUCresultsTable_32.xlsx',AUC_CLs_32)
...
AUC_indiv_mat(2:1+ff.mat4GAT.n1+ff.mat4GAT.n3,1:15)=AUC_indiv_mat(1:ff.mat4GAT.n1+ff.mat4GAT.n3,1:15);
AUC_indiv_mat(1,1:15)={'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn'};
save AUCdata.mat -v7 AUC_indiv_mat
xlswrite('AUCdata.xlsx',AUC_indiv_mat)
...
AUC_CLs_31{13,5} = CL_Pval(auc_MNodeBetw_3_rand - auc_MNodeBetw_1_rand, auc_MNodeBetw_3 - auc_MNodeBetw_1,'AUC_MNodeBetw',Tail);
...
AUC_CLs_31(2:14,1:6)=AUC_CLs_31(1:13,1:6);
AUC_CLs_31(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable_31.mat -v7 AUC_CLs_31
xlswrite('AUCresultsTable_31.xlsx',AUC_CLs_31)
...
Dens_4_rand=Dens_4_rand(:,MinIdx:MaxIdx,:);
MClust_4_rand=MClust_4_rand(:,MinIdx:MaxIdx,:);
MDeg_4_rand=MDeg_4_rand(:,MinIdx:MaxIdx,:);
Trans_4_rand=Trans_4_rand(:,MinIdx:MaxIdx,:);
Assort_4_rand=Assort_4_rand(:,MinIdx:MaxIdx,:);
GEff_4_rand=GEff_4_rand(:,MinIdx:MaxIdx,:);
MLocEff_4_rand=MLocEff_4_rand(:,MinIdx:MaxIdx,:);
Mod_4_rand=Mod_4_rand(:,MinIdx:MaxIdx,:);
ModL_4_rand=ModL_4_rand(:,MinIdx:MaxIdx,:);
PathL_4_rand=PathL_4_rand(:,MinIdx:MaxIdx,:);
MNodeBetw_4_rand=MNodeBetw_4_rand(:,MinIdx:MaxIdx,:);
MEdgeBetw_4_rand=MEdgeBetw_4_rand(:,MinIdx:MaxIdx,:);
Lambda_4_rand=Lambda_4_rand(:,MinIdx:MaxIdx,:);
Gamma_4_rand=Gamma_4_rand(:,MinIdx:MaxIdx,:);
Sigma_4_rand=Sigma_4_rand(:,MinIdx:MaxIdx,:);
...
Dens_4=Dens_4(:,MinIdx:MaxIdx);
MClust_4=MClust_4(:,MinIdx:MaxIdx);
MDeg_4=MDeg_4(:,MinIdx:MaxIdx);
Trans_4=Trans_4(:,MinIdx:MaxIdx);
Assort_4=Assort_4(:,MinIdx:MaxIdx);
GEff_4=GEff_4(:,MinIdx:MaxIdx);
MLocEff_4=MLocEff_4(:,MinIdx:MaxIdx);
Mod_4=Mod_4(:,MinIdx:MaxIdx);
ModL_4=ModL_4(:,MinIdx:MaxIdx);
PathL_4=PathL_4(:,MinIdx:MaxIdx);
MNodeBetw_4=MNodeBetw_4(:,MinIdx:MaxIdx);
MEdgeBetw_4=MEdgeBetw_4(:,MinIdx:MaxIdx);
Lambda_4=Lambda_4(:,MinIdx:MaxIdx);
Gamma_4=Gamma_4(:,MinIdx:MaxIdx);
Sigma_4=Sigma_4(:,MinIdx:MaxIdx);

fprintf('%-4s\n',['saving net measures across new threshold range...']);

cd ../..
dd=pwd;
mkdir('AUC_Results/AUC_Results_G1_vs_G4');
cd([dd '/AUC_Results/AUC_Results_G1_vs_G4']);
...
save NetMesPerDens_AveAcrossDens.mat -v7 Dens_1_rand MClust_1_rand MDeg_1_rand Trans_1_rand ...
    ...
    Sigma_4_rand Dens_4 MClust_4 MDeg_4 Trans_4 Assort_4 GEff_4 MLocEff_4 Mod_4 ModL_4 PathL_4 MNodeBetw_4 ...
    MEdgeBetw_4 Lambda_4 Gamma_4 Sigma_4
...
auc_MClust_4 = trapz(iXax,MClust_4,2);
auc_MDeg_4 = trapz(iXax,MDeg_4,2);
auc_Trans_4 = trapz(iXax,Trans_4,2);
auc_Assort_4 = trapz(iXax,Assort_4,2);
auc_GEff_4 = trapz(iXax,GEff_4,2);
auc_MLocEff_4 = trapz(iXax,MLocEff_4,2);
auc_Mod_4 = trapz(iXax,Mod_4,2);
auc_ModL_4 = trapz(iXax,ModL_4,2);
auc_PathL_4 = trapz(iXax,PathL_4,2);
auc_MNodeBetw_4 = trapz(iXax,MNodeBetw_4,2);
auc_MEdgeBetw_4 = trapz(iXax,MEdgeBetw_4,2);
auc_Lambda_4 = trapz(iXax,Lambda_4,2);
auc_Gamma_4 = trapz(iXax,Gamma_4,2);
auc_Sigma_4 = trapz(iXax,Sigma_4,2);
...
auc_MClust_4_rand = trapz(iXax,MClust_4_rand,2);
auc_MDeg_4_rand = trapz(iXax,MDeg_4_rand,2);
auc_Trans_4_rand = trapz(iXax,Trans_4_rand,2);
auc_Assort_4_rand = trapz(iXax,Assort_4_rand,2);
auc_GEff_4_rand = trapz(iXax,GEff_4_rand,2);
auc_MLocEff_4_rand = trapz(iXax,MLocEff_4_rand,2);
auc_Mod_4_rand = trapz(iXax,Mod_4_rand,2);
auc_ModL_4_rand = trapz(iXax,ModL_4_rand,2);
auc_PathL_4_rand = trapz(iXax,PathL_4_rand,2);
auc_MNodeBetw_4_rand = trapz(iXax,MNodeBetw_4_rand,2);
auc_MEdgeBetw_4_rand = trapz(iXax,MEdgeBetw_4_rand,2);
auc_Lambda_4_rand = trapz(iXax,Lambda_4_rand,2);
auc_Gamma_4_rand = trapz(iXax,Gamma_4_rand,2);
auc_Sigma_4_rand = trapz(iXax,Sigma_4_rand,2);
...
save AUC_NetMesPerDens_AveAcrossDens.mat -v7  auc_MClust_1_rand auc_MDeg_1_rand auc_Trans_1_rand ...
    ...
    auc_Sigma_1_rand auc_MClust_1 auc_MDeg_1 auc_Trans_1 auc_Assort_1 auc_GEff_1 auc_MLocEff_1 ...
    auc_Mod_1 auc_ModL_1 auc_PathL_1 auc_MNodeBetw_1 auc_MEdgeBetw_1 auc_Lambda_1 auc_Gamma_1 auc_Sigma_1 ...
    auc_MClust_4_rand auc_MDeg_4_rand auc_Trans_4_rand ...
    auc_Assort_4_rand auc_GEff_4_rand auc_MLocEff_4_rand auc_Mod_4_rand auc_ModL_4_rand ...
    auc_PathL_4_rand auc_MNodeBetw_4_rand auc_MEdgeBetw_4_rand auc_Lambda_4_rand auc_Gamma_4_rand ...
    auc_Sigma_4_rand auc_MClust_4 auc_MDeg_4 auc_Trans_4 auc_Assort_4 auc_GEff_4 auc_MLocEff_4 auc_Mod_4 auc_ModL_4 auc_PathL_4 ...
    auc_MNodeBetw_4 auc_MEdgeBetw_4 auc_Lambda_4 auc_Gamma_4 auc_Sigma_4

AUC_indiv_mat= num2cell([[1:ff.mat4GAT.n1 1:ff.mat4GAT.n4]' [ones(ff.mat4GAT.n1,1)*1; ones(ff.mat4GAT.n4,1)*4]  [auc_MClust_1; auc_MClust_4] ...
    [auc_MDeg_1; auc_MDeg_4] [auc_Trans_1; auc_Trans_4] [auc_Assort_1; auc_Assort_4] [auc_GEff_1; auc_GEff_4] [auc_MLocEff_1; auc_MLocEff_4] ...
    [auc_Mod_1; auc_Mod_4] [auc_PathL_1; auc_PathL_4] [auc_Lambda_1; auc_Lambda_4] [auc_Gamma_1; auc_Gamma_4] [auc_Sigma_1; auc_Sigma_4]...
    [auc_MEdgeBetw_1; auc_MEdgeBetw_4] [auc_MNodeBetw_1; auc_MNodeBetw_4]]);

AUC_indiv_mat(2:1+ff.mat4GAT.n1+ff.mat4GAT.n4,1:15)=AUC_indiv_mat(1:ff.mat4GAT.n1+ff.mat4GAT.n4,1:15);
AUC_indiv_mat(1,1:15)={'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn'};
save AUCdata.mat -v7 AUC_indiv_mat
xlswrite('AUCdata.xlsx',AUC_indiv_mat)
...
auc_MClust_4 = mean(auc_MClust_4);
auc_MDeg_4 = mean(auc_MDeg_4);
auc_Trans_4 = mean(auc_Trans_4);
auc_Assort_4 = mean(auc_Assort_4);
auc_GEff_4 = mean(auc_GEff_4);
auc_MLocEff_4 = mean(auc_MLocEff_4);
auc_Mod_4 = mean(auc_Mod_4);
auc_ModL_4 = mean(auc_ModL_4);
auc_PathL_4 = mean(auc_PathL_4);
auc_MNodeBetw_4 = mean(auc_MNodeBetw_4);
auc_MEdgeBetw_4 = mean(auc_MEdgeBetw_4);
auc_Lambda_4 = mean(auc_Lambda_4);
auc_Gamma_4 = mean(auc_Gamma_4);
auc_Sigma_4 = mean(auc_Sigma_4);
...
auc_MClust_4_rand = mean(auc_MClust_4_rand,1);auc_MClust_4_rand = reshape(auc_MClust_4_rand,1,nRand);
auc_MDeg_4_rand = mean(auc_MDeg_4_rand,1);auc_MDeg_4_rand = reshape(auc_MDeg_4_rand,1,nRand);
auc_Trans_4_rand = mean(auc_Trans_4_rand,1);auc_Trans_4_rand = reshape(auc_Trans_4_rand ,1,nRand);
auc_Assort_4_rand = mean(auc_Assort_4_rand,1);auc_Assort_4_rand = reshape(auc_Assort_4_rand ,1,nRand);
auc_GEff_4_rand = mean(auc_GEff_4_rand,1);auc_GEff_4_rand = reshape(auc_GEff_4_rand ,1,nRand);
auc_MLocEff_4_rand = mean(auc_MLocEff_4_rand,1);auc_MLocEff_4_rand = reshape(auc_MLocEff_4_rand ,1,nRand);
auc_Mod_4_rand = mean(auc_Mod_4_rand,1);auc_Mod_4_rand = reshape(auc_Mod_4_rand ,1,nRand);
auc_ModL_4_rand = mean(auc_ModL_4_rand,1);auc_ModL_4_rand = reshape(auc_ModL_4_rand ,1,nRand);
auc_PathL_4_rand = mean(auc_PathL_4_rand,1);auc_PathL_4_rand = reshape(auc_PathL_4_rand ,1,nRand);
auc_MNodeBetw_4_rand = mean(auc_MNodeBetw_4_rand,1);auc_MNodeBetw_4_rand = reshape(auc_MNodeBetw_4_rand ,1,nRand);
auc_MEdgeBetw_4_rand = mean(auc_MEdgeBetw_4_rand,1);auc_MEdgeBetw_4_rand = reshape(auc_MEdgeBetw_4_rand ,1,nRand);
auc_Lambda_4_rand = mean(auc_Lambda_4_rand,1);auc_Lambda_4_rand = reshape( auc_Lambda_4_rand,1,nRand);
auc_Gamma_4_rand = mean(auc_Gamma_4_rand,1);auc_Gamma_4_rand = reshape(auc_Gamma_4_rand ,1,nRand);
auc_Sigma_4_rand = mean(auc_Sigma_4_rand,1);auc_Sigma_4_rand = reshape(auc_Sigma_4_rand ,1,nRand);
...
save AUC_Mean.mat -v7 auc_MClust_1_rand auc_MDeg_1_rand auc_Trans_1_rand ...
    ...
    auc_Assort_4_rand auc_GEff_4_rand auc_MLocEff_4_rand auc_Mod_4_rand auc_ModL_4_rand ...
    auc_PathL_4_rand auc_MNodeBetw_4_rand auc_MEdgeBetw_4_rand auc_Lambda_4_rand auc_Gamma_4_rand ...
    auc_Sigma_4_rand auc_MClust_4 auc_MDeg_4 auc_Trans_4 ...
    auc_Assort_4 auc_GEff_4 auc_MLocEff_4 auc_Mod_4 auc_ModL_4 auc_PathL_4 auc_MNodeBetw_4 ...
    auc_MEdgeBetw_4 auc_Lambda_4 auc_Gamma_4 auc_Sigma_4

p = Alpha;

CL_auc_41_Geff = CL_per(auc_GEff_4_rand' - auc_GEff_1_rand', p);
CL_auc_41_Leff = CL_per(auc_MLocEff_4_rand' - auc_MLocEff_1_rand', p);
CL_auc_41_Trans = CL_per(auc_Trans_4_rand' - auc_Trans_1_rand', p);
CL_auc_41_Mod = CL_per(auc_Mod_4_rand' - auc_Mod_1_rand', p);
CL_auc_41_Lambda = CL_per(auc_Lambda_4_rand' - auc_Lambda_1_rand', p);
CL_auc_41_Gamma = CL_per(auc_Gamma_4_rand' - auc_Gamma_1_rand', p);
CL_auc_41_Sigma = CL_per(auc_Sigma_4_rand' - auc_Sigma_1_rand', p);
CL_auc_41_Assort = CL_per(auc_Assort_4_rand' - auc_Assort_1_rand', p);
CL_auc_41_PathL = CL_per(auc_PathL_4_rand' - auc_PathL_1_rand', p);
CL_auc_41_MClust = CL_per(auc_MClust_4_rand' - auc_MClust_1_rand', p);
CL_auc_41_MDeg = CL_per(auc_MDeg_4_rand' - auc_MDeg_1_rand', p);
CL_auc_41_MEdgeBetw = CL_per(auc_MEdgeBetw_4_rand' - auc_MEdgeBetw_1_rand', p);
CL_auc_41_MNodeBetw = CL_per(auc_MNodeBetw_4_rand' - auc_MNodeBetw_1_rand', p);

AUC_CLs_41{1,1} = 'MClust';
AUC_CLs_41{2,1} = 'MDegree';
AUC_CLs_41{3,1} = 'Trans';
AUC_CLs_41{4,1} = 'Assort';
AUC_CLs_41{5,1} = 'Eglob';
AUC_CLs_41{6,1} = 'MEloc';
AUC_CLs_41{7,1} = 'Mod';
AUC_CLs_41{8,1} = 'PathL';
AUC_CLs_41{9,1} = 'Lambda';
AUC_CLs_41{10,1} = 'Gamma';
AUC_CLs_41{11,1} = 'Sigma';
AUC_CLs_41{12,1} = 'MEdgeBetw';
AUC_CLs_41{13,1} = 'MNodeBetw';

% AUC diff
AUC_CLs_41{1,2} = auc_MClust_4 - auc_MClust_1;
AUC_CLs_41{2,2} = auc_MDeg_4 - auc_MDeg_1;
AUC_CLs_41{3,2} = auc_Trans_4 - auc_Trans_1;
AUC_CLs_41{4,2} = auc_Assort_4 - auc_Assort_1;
AUC_CLs_41{5,2} = auc_GEff_4 - auc_GEff_1;
AUC_CLs_41{6,2} = auc_MLocEff_4 - auc_MLocEff_1;
AUC_CLs_41{7,2} = auc_Mod_4 - auc_Mod_1;
AUC_CLs_41{8,2} = auc_PathL_4 - auc_PathL_1;
AUC_CLs_41{9,2} = auc_Lambda_4 - auc_Lambda_1;
AUC_CLs_41{10,2} = auc_Gamma_4 - auc_Gamma_1;
AUC_CLs_41{11,2} = auc_Sigma_4 - auc_Sigma_1;
AUC_CLs_41{12,2} = auc_MEdgeBetw_4 - auc_MEdgeBetw_1;
AUC_CLs_41{13,2} = auc_MNodeBetw_4 - auc_MNodeBetw_1;

% Lower limit CL
AUC_CLs_41{1,3} = CL_auc_41_MClust(2,:);
AUC_CLs_41{2,3} = CL_auc_41_MDeg(2,:);
AUC_CLs_41{3,3} = CL_auc_41_Trans(2,:);
AUC_CLs_41{4,3} = CL_auc_41_Assort(2,:);
AUC_CLs_41{5,3} = CL_auc_41_Geff(2,:);
AUC_CLs_41{6,3} = CL_auc_41_Leff(2,:);
AUC_CLs_41{7,3} = CL_auc_41_Mod(2,:);
AUC_CLs_41{8,3} = CL_auc_41_PathL(2,:);
AUC_CLs_41{9,3} = CL_auc_41_Lambda(2,:);
AUC_CLs_41{10,3} = CL_auc_41_Gamma(2,:);
AUC_CLs_41{11,3} = CL_auc_41_Sigma(2,:);
AUC_CLs_41{12,3} = CL_auc_41_MEdgeBetw(2,:);
AUC_CLs_41{13,3} = CL_auc_41_MNodeBetw(2,:);

% Upper limit CL
AUC_CLs_41{1,4} = CL_auc_41_MClust(1,:);
AUC_CLs_41{2,4} = CL_auc_41_MDeg(1,:);
AUC_CLs_41{3,4} = CL_auc_41_Trans(1,:);
AUC_CLs_41{4,4} = CL_auc_41_Assort(1,:);
AUC_CLs_41{5,4} = CL_auc_41_Geff(1,:);
AUC_CLs_41{6,4} = CL_auc_41_Leff(1,:);
AUC_CLs_41{7,4} = CL_auc_41_Mod(1,:);
AUC_CLs_41{8,4} = CL_auc_41_PathL(1,:);
AUC_CLs_41{9,4} = CL_auc_41_Lambda(1,:);
AUC_CLs_41{10,4} = CL_auc_41_Gamma(1,:);
AUC_CLs_41{11,4} = CL_auc_41_Sigma(1,:);
AUC_CLs_41{12,4} = CL_auc_41_MEdgeBetw(1,:);
AUC_CLs_41{13,4} = CL_auc_41_MNodeBetw(1,:);

% p values
AUC_CLs_41{1,5} = CL_Pval(auc_MClust_4_rand - auc_MClust_1_rand, auc_MClust_4 - auc_MClust_1,'AUC_MClust',Tail);
AUC_CLs_41{2,5} = CL_Pval(auc_MDeg_4_rand - auc_MDeg_1_rand, auc_MDeg_4 - auc_MDeg_1,'AUC_MDeg',Tail);
AUC_CLs_41{3,5} = CL_Pval(auc_Trans_4_rand - auc_Trans_1_rand, auc_Trans_4 - auc_Trans_1,'AUC_Trans',Tail);
AUC_CLs_41{4,5} = CL_Pval(auc_Assort_4_rand - auc_Assort_1_rand, auc_Assort_4 - auc_Assort_1,'AUC_Assort',Tail);
AUC_CLs_41{5,5} = CL_Pval(auc_GEff_4_rand - auc_GEff_1_rand, auc_GEff_4 - auc_GEff_1,'AUC_GEff',Tail);
AUC_CLs_41{6,5} = CL_Pval(auc_MLocEff_4_rand - auc_MLocEff_1_rand, auc_MLocEff_4 - auc_MLocEff_1,'AUC_MLocEff',Tail);
AUC_CLs_41{7,5} = CL_Pval(auc_Mod_4_rand - auc_Mod_1_rand, auc_Mod_4 - auc_Mod_1,'AUC_Mod',Tail);
AUC_CLs_41{8,5} = CL_Pval(auc_PathL_4_rand - auc_PathL_1_rand, auc_PathL_4 - auc_PathL_1,'AUC_PathL',Tail);
AUC_CLs_41{9,5} = CL_Pval(auc_Lambda_4_rand - auc_Lambda_1_rand, auc_Lambda_4 - auc_Lambda_1,'AUC_Lambda',Tail);
AUC_CLs_41{10,5} = CL_Pval(auc_Gamma_4_rand - auc_Gamma_1_rand, auc_Gamma_4 - auc_Gamma_1,'AUC_Gamma',Tail);
AUC_CLs_41{11,5} = CL_Pval(auc_Sigma_4_rand - auc_Sigma_1_rand, auc_Sigma_4 - auc_Sigma_1,'AUC_Sigma',Tail);
AUC_CLs_41{12,5} = CL_Pval(auc_MEdgeBetw_4_rand - auc_MEdgeBetw_1_rand, auc_MEdgeBetw_4 - auc_MEdgeBetw_1,'AUC_MEdgeBetw',Tail);
AUC_CLs_41{13,5} = CL_Pval(auc_MNodeBetw_4_rand - auc_MNodeBetw_1_rand, auc_MNodeBetw_4 - auc_MNodeBetw_1,'AUC_MNodeBetw',Tail);


[h crit_p adj_p]=fdr_bh(abs(cell2mat(AUC_CLs_41(:,5))));
AUC_CLs_41(:,6)=num2cell(adj_p);

AUC_CLs_41(2:14,1:6)=AUC_CLs_41(1:13,1:6);
AUC_CLs_41(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable_41.mat -v7 AUC_CLs_41
xlswrite('AUCresultsTable_41.xlsx',AUC_CLs_41)
...
cd ../..
dd=pwd;
mkdir('AUC_Results/AUC_Results_G2_vs_G4');
cd([dd '/AUC_Results/AUC_Results_G2_vs_G4']);
...
save AUC_NetMesPerDens_AveAcrossDens.mat -v7 auc_MClust_2_rand auc_MDeg_2_rand auc_Trans_2_rand ...
    ...
    auc_PathL_2_rand auc_MNodeBetw_2_rand auc_MEdgeBetw_2_rand auc_Lambda_2_rand auc_Gamma_2_rand ...
    auc_Sigma_2_rand auc_MClust_2 auc_MDeg_2 auc_Trans_2 auc_Assort_2 auc_GEff_2 auc_MLocEff_2 auc_Mod_2 auc_ModL_2 auc_PathL_2 auc_MNodeBetw_2 ...
    auc_MEdgeBetw_2 auc_Lambda_2 auc_Gamma_2 auc_Sigma_2 auc_MClust_4_rand auc_MDeg_4_rand auc_Trans_4_rand ...
    auc_Assort_4_rand auc_GEff_4_rand auc_MLocEff_4_rand auc_Mod_4_rand auc_ModL_4_rand ...
    auc_PathL_4_rand auc_MNodeBetw_4_rand auc_MEdgeBetw_4_rand auc_Lambda_4_rand auc_Gamma_4_rand ...
    auc_Sigma_4_rand auc_MClust_4 auc_MDeg_4 auc_Trans_4 auc_Assort_4 auc_GEff_4 auc_MLocEff_4 auc_Mod_4 auc_ModL_4 auc_PathL_4 ...
    auc_MNodeBetw_4 auc_MEdgeBetw_4 auc_Lambda_4 auc_Gamma_4 auc_Sigma_4
...
AUC_indiv_mat= num2cell([[1:ff.mat4GAT.n2 1:ff.mat4GAT.n4]' [ones(ff.mat4GAT.n2,1)*2; ones(ff.mat4GAT.n4,1)*4]  [auc_MClust_2; auc_MClust_4] ...
    [auc_MDeg_2; auc_MDeg_4] [auc_Trans_2; auc_Trans_4] [auc_Assort_2; auc_Assort_4] [auc_GEff_2; auc_GEff_4] [auc_MLocEff_2; auc_MLocEff_4] ...
    [auc_Mod_2; auc_Mod_4] [auc_PathL_2; auc_PathL_4] [auc_Lambda_2; auc_Lambda_4] [auc_Gamma_2; auc_Gamma_4] [auc_Sigma_2; auc_Sigma_4]...
    [auc_MEdgeBetw_2; auc_MEdgeBetw_4] [auc_MNodeBetw_2; auc_MNodeBetw_4]]);

AUC_indiv_mat(2:1+ff.mat4GAT.n2+ff.mat4GAT.n4,1:15)=AUC_indiv_mat(1:ff.mat4GAT.n2+ff.mat4GAT.n4,1:15);
AUC_indiv_mat(1,1:15)={'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn'};
save AUCdata.mat -v7 AUC_indiv_mat
xlswrite('AUCdata.xlsx',AUC_indiv_mat)
...
CL_auc_42_Geff = CL_per(auc_GEff_4_rand' - auc_GEff_2_rand', p);
CL_auc_42_Leff = CL_per(auc_MLocEff_4_rand' - auc_MLocEff_2_rand', p);
CL_auc_42_Trans = CL_per(auc_Trans_4_rand' - auc_Trans_2_rand', p);
CL_auc_42_Mod = CL_per(auc_Mod_4_rand' - auc_Mod_2_rand', p);
CL_auc_42_Lambda = CL_per(auc_Lambda_4_rand' - auc_Lambda_2_rand', p);
CL_auc_42_Gamma = CL_per(auc_Gamma_4_rand' - auc_Gamma_2_rand', p);
CL_auc_42_Sigma = CL_per(auc_Sigma_4_rand' - auc_Sigma_2_rand', p);
CL_auc_42_Assort = CL_per(auc_Assort_4_rand' - auc_Assort_2_rand', p);
CL_auc_42_PathL = CL_per(auc_PathL_4_rand' - auc_PathL_2_rand', p);
CL_auc_42_MClust = CL_per(auc_MClust_4_rand' - auc_MClust_2_rand', p);
CL_auc_42_MDeg = CL_per(auc_MDeg_4_rand' - auc_MDeg_2_rand', p);
CL_auc_42_MEdgeBetw = CL_per(auc_MEdgeBetw_4_rand' - auc_MEdgeBetw_2_rand', p);
CL_auc_42_MNodeBetw = CL_per(auc_MNodeBetw_4_rand' - auc_MNodeBetw_2_rand', p);

AUC_CLs_42{1,1} = 'MClust';
AUC_CLs_42{2,1} = 'MDegree';
AUC_CLs_42{3,1} = 'Trans';
AUC_CLs_42{4,1} = 'Assort';
AUC_CLs_42{5,1} = 'Eglob';
AUC_CLs_42{6,1} = 'MEloc';
AUC_CLs_42{7,1} = 'Mod';
AUC_CLs_42{8,1} = 'PathL';
AUC_CLs_42{9,1} = 'Lambda';
AUC_CLs_42{10,1} = 'Gamma';
AUC_CLs_42{11,1} = 'Sigma';
AUC_CLs_42{12,1} = 'MEdgeBtwn';
AUC_CLs_42{13,1} = 'MNodeBtwn';

% AUC diff
AUC_CLs_42{1,2} = auc_MClust_4 - auc_MClust_2;
AUC_CLs_42{2,2} = auc_MDeg_4 - auc_MDeg_2;
AUC_CLs_42{3,2} = auc_Trans_4 - auc_Trans_2;
AUC_CLs_42{4,2} = auc_Assort_4 - auc_Assort_2;
AUC_CLs_42{5,2} = auc_GEff_4 - auc_GEff_2;
AUC_CLs_42{6,2} = auc_MLocEff_4 - auc_MLocEff_2;
AUC_CLs_42{7,2} = auc_Mod_4 - auc_Mod_2;
AUC_CLs_42{8,2} = auc_PathL_4 - auc_PathL_2;
AUC_CLs_42{9,2} = auc_Lambda_4 - auc_Lambda_2;
AUC_CLs_42{10,2} = auc_Gamma_4 - auc_Gamma_2;
AUC_CLs_42{11,2} = auc_Sigma_4 - auc_Sigma_2;
AUC_CLs_42{12,2} = auc_MEdgeBetw_4 - auc_MEdgeBetw_2;
AUC_CLs_42{13,2} = auc_MNodeBetw_4 - auc_MNodeBetw_2;

% Lower limit CL
AUC_CLs_42{1,3} = CL_auc_42_MClust(2,:);
AUC_CLs_42{2,3} = CL_auc_42_MDeg(2,:);
AUC_CLs_42{3,3} = CL_auc_42_Trans(2,:);
AUC_CLs_42{4,3} = CL_auc_42_Assort(2,:);
AUC_CLs_42{5,3} = CL_auc_42_Geff(2,:);
AUC_CLs_42{6,3} = CL_auc_42_Leff(2,:);
AUC_CLs_42{7,3} = CL_auc_42_Mod(2,:);
AUC_CLs_42{8,3} = CL_auc_42_PathL(2,:);
AUC_CLs_42{9,3} = CL_auc_42_Lambda(2,:);
AUC_CLs_42{10,3} = CL_auc_42_Gamma(2,:);
AUC_CLs_42{11,3} = CL_auc_42_Sigma(2,:);
AUC_CLs_42{12,3} = CL_auc_42_MEdgeBetw(2,:);
AUC_CLs_42{13,3} = CL_auc_42_MNodeBetw(2,:);

% Upper limit CL
AUC_CLs_42{1,4} = CL_auc_42_MClust(1,:);
AUC_CLs_42{2,4} = CL_auc_42_MDeg(1,:);
AUC_CLs_42{3,4} = CL_auc_42_Trans(1,:);
AUC_CLs_42{4,4} = CL_auc_42_Assort(1,:);
AUC_CLs_42{5,4} = CL_auc_42_Geff(1,:);
AUC_CLs_42{6,4} = CL_auc_42_Leff(1,:);
AUC_CLs_42{7,4} = CL_auc_42_Mod(1,:);
AUC_CLs_42{8,4} = CL_auc_42_PathL(1,:);
AUC_CLs_42{9,4} = CL_auc_42_Lambda(1,:);
AUC_CLs_42{10,4} = CL_auc_42_Gamma(1,:);
AUC_CLs_42{11,4} = CL_auc_42_Sigma(1,:);
AUC_CLs_42{12,4} = CL_auc_42_MEdgeBetw(1,:);
AUC_CLs_42{13,4} = CL_auc_42_MNodeBetw(1,:);

% p values
AUC_CLs_42{1,5} = CL_Pval(auc_MClust_4_rand - auc_MClust_2_rand, auc_MClust_4 - auc_MClust_2,'AUC_MClust',Tail);
AUC_CLs_42{2,5} = CL_Pval(auc_MDeg_4_rand - auc_MDeg_2_rand, auc_MDeg_4 - auc_MDeg_2,'AUC_MDeg',Tail);
AUC_CLs_42{3,5} = CL_Pval(auc_Trans_4_rand - auc_Trans_2_rand, auc_Trans_4 - auc_Trans_2,'AUC_Trans',Tail);
AUC_CLs_42{4,5} = CL_Pval(auc_Assort_4_rand - auc_Assort_2_rand, auc_Assort_4 - auc_Assort_2,'AUC_Assort',Tail);
AUC_CLs_42{5,5} = CL_Pval(auc_GEff_4_rand - auc_GEff_2_rand, auc_GEff_4 - auc_GEff_2,'AUC_GEff',Tail);
AUC_CLs_42{6,5} = CL_Pval(auc_MLocEff_4_rand - auc_MLocEff_2_rand, auc_MLocEff_4 - auc_MLocEff_2,'AUC_MLocEff',Tail);
AUC_CLs_42{7,5} = CL_Pval(auc_Mod_4_rand - auc_Mod_2_rand, auc_Mod_4 - auc_Mod_2,'AUC_Mod',Tail);
AUC_CLs_42{8,5} = CL_Pval(auc_PathL_4_rand - auc_PathL_2_rand, auc_PathL_4 - auc_PathL_2,'AUC_PathL',Tail);
AUC_CLs_42{9,5} = CL_Pval(auc_Lambda_4_rand - auc_Lambda_2_rand, auc_Lambda_4 - auc_Lambda_2,'AUC_Lambda',Tail);
AUC_CLs_42{10,5} = CL_Pval(auc_Gamma_4_rand - auc_Gamma_2_rand, auc_Gamma_4 - auc_Gamma_2,'AUC_Gamma',Tail);
AUC_CLs_42{11,5} = CL_Pval(auc_Sigma_4_rand - auc_Sigma_2_rand, auc_Sigma_4 - auc_Sigma_2,'AUC_Sigma',Tail);
AUC_CLs_42{12,5} = CL_Pval(auc_MEdgeBetw_4_rand - auc_MEdgeBetw_2_rand, auc_MEdgeBetw_4 - auc_MEdgeBetw_2,'AUC_MEdgeBetw',Tail);
AUC_CLs_42{13,5} = CL_Pval(auc_MNodeBetw_4_rand - auc_MNodeBetw_2_rand, auc_MNodeBetw_4 - auc_MNodeBetw_2,'AUC_MNodeBetw',Tail);



[h crit_p adj_p]=fdr_bh(abs(cell2mat(AUC_CLs_42(:,5))));
AUC_CLs_42(:,6)=num2cell(adj_p);

AUC_CLs_42(2:14,1:6)=AUC_CLs_42(1:13,1:6);
AUC_CLs_42(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable_42.mat -v7 AUC_CLs_42
xlswrite('AUCresultsTable_42.xlsx',AUC_CLs_42)
...
cd ../..
dd=pwd;
mkdir('AUC_Results/AUC_Results_G3_vs_G4');
cd([dd '/AUC_Results/AUC_Results_G3_vs_G4']);

save NetMesPerDens_AveAcrossDens.mat -v7 Dens_3_rand MClust_3_rand MDeg_3_rand Trans_3_rand ...
    Assort_3_rand GEff_3_rand MLocEff_3_rand Mod_3_rand ModL_3_rand ...
    PathL_3_rand MNodeBetw_3_rand MEdgeBetw_3_rand Lambda_3_rand Gamma_3_rand ...
    Sigma_3_rand Dens_3 MClust_3 MDeg_3 Trans_3 Assort_3 GEff_3 MLocEff_3 Mod_3 ModL_3 PathL_3 MNodeBetw_3 ...
    MEdgeBetw_3 Lambda_3 Gamma_3 Sigma_3 ...
...
save AUC_NetMesPerDens_AveAcrossDens.mat -v7 auc_MClust_3_rand auc_MDeg_3_rand auc_Trans_3_rand ...
    auc_Assort_3_rand auc_GEff_3_rand auc_MLocEff_3_rand auc_Mod_3_rand auc_ModL_3_rand ...
    auc_PathL_3_rand auc_MNodeBetw_3_rand auc_MEdgeBetw_3_rand auc_Lambda_3_rand auc_Gamma_3_rand ...
    auc_Sigma_3_rand auc_MClust_3 auc_MDeg_3 auc_Trans_3 auc_Assort_3 auc_GEff_3 auc_MLocEff_3 auc_Mod_3 auc_ModL_3 auc_PathL_3 auc_MNodeBetw_3 ...
    auc_MEdgeBetw_3 auc_Lambda_3 auc_Gamma_3 auc_Sigma_3 auc_MClust_4_rand auc_MDeg_4_rand auc_Trans_4_rand ...
    auc_Assort_4_rand auc_GEff_4_rand auc_MLocEff_4_rand auc_Mod_4_rand auc_ModL_4_rand ...
    auc_PathL_4_rand auc_MNodeBetw_4_rand auc_MEdgeBetw_4_rand auc_Lambda_4_rand auc_Gamma_4_rand ...
    auc_Sigma_4_rand auc_MClust_4 auc_MDeg_4 auc_Trans_4 auc_Assort_4 auc_GEff_4 auc_MLocEff_4 auc_Mod_4 auc_ModL_4 auc_PathL_4 ...
    auc_MNodeBetw_4 auc_MEdgeBetw_4 auc_Lambda_4 auc_Gamma_4 auc_Sigma_4

AUC_indiv_mat= num2cell([[1:ff.mat4GAT.n3 1:ff.mat4GAT.n4]' [ones(ff.mat4GAT.n3,1)*3; ones(ff.mat4GAT.n4,1)*4]  [auc_MClust_3; auc_MClust_4] ...
    [auc_MDeg_3; auc_MDeg_4] [auc_Trans_3; auc_Trans_4] [auc_Assort_3; auc_Assort_4] [auc_GEff_3; auc_GEff_4] [auc_MLocEff_3; auc_MLocEff_4] ...
    [auc_Mod_3; auc_Mod_4] [auc_PathL_3; auc_PathL_4] [auc_Lambda_3; auc_Lambda_4] [auc_Gamma_3; auc_Gamma_4] [auc_Sigma_3; auc_Sigma_4]...
    [auc_MEdgeBetw_3; auc_MEdgeBetw_4] [auc_MNodeBetw_3; auc_MNodeBetw_4]]);

AUC_indiv_mat(2:1+ff.mat4GAT.n3+ff.mat4GAT.n4,1:15)=AUC_indiv_mat(1:ff.mat4GAT.n3+ff.mat4GAT.n4,1:15);
AUC_indiv_mat(1,1:15)={'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn'};
save AUCdata.mat -v7 AUC_indiv_mat
xlswrite('AUCdata.xlsx',AUC_indiv_mat)

nRand=size(auc_MClust_3_rand,3);
...
save AUC_Mean.mat -v7 auc_MClust_3_rand auc_MDeg_3_rand auc_Trans_3_rand ...
    auc_Assort_3_rand auc_GEff_3_rand auc_MLocEff_3_rand auc_Mod_3_rand auc_ModL_3_rand ...
    auc_PathL_3_rand auc_MNodeBetw_3_rand auc_MEdgeBetw_3_rand auc_Lambda_3_rand auc_Gamma_3_rand ...
    auc_Sigma_3_rand auc_MClust_3 auc_MDeg_3 auc_Trans_3 ...
    auc_Assort_3 auc_GEff_3 auc_MLocEff_3 auc_Mod_3 auc_ModL_3 auc_PathL_3 auc_MNodeBetw_3 ...
...
CL_auc_43_Geff = CL_per(auc_GEff_4_rand' - auc_GEff_3_rand', p);
CL_auc_43_Leff = CL_per(auc_MLocEff_4_rand' - auc_MLocEff_3_rand', p);
CL_auc_43_Trans = CL_per(auc_Trans_4_rand' - auc_Trans_3_rand', p);
CL_auc_43_Mod = CL_per(auc_Mod_4_rand' - auc_Mod_3_rand', p);
CL_auc_43_Lambda = CL_per(auc_Lambda_4_rand' - auc_Lambda_3_rand', p);
CL_auc_43_Gamma = CL_per(auc_Gamma_4_rand' - auc_Gamma_3_rand', p);
CL_auc_43_Sigma = CL_per(auc_Sigma_4_rand' - auc_Sigma_3_rand', p);
CL_auc_43_Assort = CL_per(auc_Assort_4_rand' - auc_Assort_3_rand', p);
CL_auc_43_PathL = CL_per(auc_PathL_4_rand' - auc_PathL_3_rand', p);
CL_auc_43_MClust = CL_per(auc_MClust_4_rand' - auc_MClust_3_rand', p);
CL_auc_43_MDeg = CL_per(auc_MDeg_4_rand' - auc_MDeg_3_rand', p);
CL_auc_43_MEdgeBetw = CL_per(auc_MEdgeBetw_4_rand' - auc_MEdgeBetw_3_rand', p);
CL_auc_43_MNodeBetw = CL_per(auc_MNodeBetw_4_rand' - auc_MNodeBetw_3_rand', p);

AUC_CLs_43{1,1} = 'MClust';
AUC_CLs_43{2,1} = 'MDegree';
AUC_CLs_43{3,1} = 'Trans';
AUC_CLs_43{4,1} = 'Assort';
AUC_CLs_43{5,1} = 'Eglob';
AUC_CLs_43{6,1} = 'MEloc';
AUC_CLs_43{7,1} = 'Mod';
AUC_CLs_43{8,1} = 'PathL';
AUC_CLs_43{9,1} = 'Lambda';
AUC_CLs_43{10,1} = 'Gamma';
AUC_CLs_43{11,1} = 'Sigma';
AUC_CLs_43{12,1} = 'MEdgeBtwn';
AUC_CLs_43{13,1} = 'MNodeBtwn';

% AUC diff
AUC_CLs_43{1,2} = auc_MClust_4 - auc_MClust_3;
AUC_CLs_43{2,2} = auc_MDeg_4 - auc_MDeg_3;
AUC_CLs_43{3,2} = auc_Trans_4 - auc_Trans_3;
AUC_CLs_43{4,2} = auc_Assort_4 - auc_Assort_3;
AUC_CLs_43{5,2} = auc_GEff_4 - auc_GEff_3;
AUC_CLs_43{6,2} = auc_MLocEff_4 - auc_MLocEff_3;
AUC_CLs_43{7,2} = auc_Mod_4 - auc_Mod_3;
AUC_CLs_43{8,2} = auc_PathL_4 - auc_PathL_3;
AUC_CLs_43{9,2} = auc_Lambda_4 - auc_Lambda_3;
AUC_CLs_43{10,2} = auc_Gamma_4 - auc_Gamma_3;
AUC_CLs_43{11,2} = auc_Sigma_4 - auc_Sigma_3;
AUC_CLs_43{12,2} = auc_MEdgeBetw_4 - auc_MEdgeBetw_3;
AUC_CLs_43{13,2} = auc_MNodeBetw_4 - auc_MNodeBetw_3;

% Lower limit CL
AUC_CLs_43{1,3} = CL_auc_43_MClust(2,:);
AUC_CLs_43{2,3} = CL_auc_43_MDeg(2,:);
AUC_CLs_43{3,3} = CL_auc_43_Trans(2,:);
AUC_CLs_43{4,3} = CL_auc_43_Assort(2,:);
AUC_CLs_43{5,3} = CL_auc_43_Geff(2,:);
AUC_CLs_43{6,3} = CL_auc_43_Leff(2,:);
AUC_CLs_43{7,3} = CL_auc_43_Mod(2,:);
AUC_CLs_43{8,3} = CL_auc_43_PathL(2,:);
AUC_CLs_43{9,3} = CL_auc_43_Lambda(2,:);
AUC_CLs_43{10,3} = CL_auc_43_Gamma(2,:);
AUC_CLs_43{11,3} = CL_auc_43_Sigma(2,:);
AUC_CLs_43{12,3} = CL_auc_43_MEdgeBetw(2,:);
AUC_CLs_43{13,3} = CL_auc_43_MNodeBetw(2,:);

% Upper limit CL
AUC_CLs_43{1,4} = CL_auc_43_MClust(1,:);
AUC_CLs_43{2,4} = CL_auc_43_MDeg(1,:);
AUC_CLs_43{3,4} = CL_auc_43_Trans(1,:);
AUC_CLs_43{4,4} = CL_auc_43_Assort(1,:);
AUC_CLs_43{5,4} = CL_auc_43_Geff(1,:);
AUC_CLs_43{6,4} = CL_auc_43_Leff(1,:);
AUC_CLs_43{7,4} = CL_auc_43_Mod(1,:);
AUC_CLs_43{8,4} = CL_auc_43_PathL(1,:);
AUC_CLs_43{9,4} = CL_auc_43_Lambda(1,:);
AUC_CLs_43{10,4} = CL_auc_43_Gamma(1,:);
AUC_CLs_43{11,4} = CL_auc_43_Sigma(1,:);
AUC_CLs_43{12,4} = CL_auc_43_MEdgeBetw(1,:);
AUC_CLs_43{13,4} = CL_auc_43_MNodeBetw(1,:);

% p values
AUC_CLs_43{1,5} = CL_Pval(auc_MClust_4_rand - auc_MClust_3_rand, auc_MClust_4 - auc_MClust_3,'AUC_MClust',Tail);
AUC_CLs_43{2,5} = CL_Pval(auc_MDeg_4_rand - auc_MDeg_3_rand, auc_MDeg_4 - auc_MDeg_3,'AUC_MDeg',Tail);
AUC_CLs_43{3,5} = CL_Pval(auc_Trans_4_rand - auc_Trans_3_rand, auc_Trans_4 - auc_Trans_3,'AUC_Trans',Tail);
AUC_CLs_43{4,5} = CL_Pval(auc_Assort_4_rand - auc_Assort_3_rand, auc_Assort_4 - auc_Assort_3,'AUC_Assort',Tail);
AUC_CLs_43{5,5} = CL_Pval(auc_GEff_4_rand - auc_GEff_3_rand, auc_GEff_4 - auc_GEff_3,'AUC_GEff',Tail);
AUC_CLs_43{6,5} = CL_Pval(auc_MLocEff_4_rand - auc_MLocEff_3_rand, auc_MLocEff_4 - auc_MLocEff_3,'AUC_MLocEff',Tail);
AUC_CLs_43{7,5} = CL_Pval(auc_Mod_4_rand - auc_Mod_3_rand, auc_Mod_4 - auc_Mod_3,'AUC_Mod',Tail);
AUC_CLs_43{8,5} = CL_Pval(auc_PathL_4_rand - auc_PathL_3_rand, auc_PathL_4 - auc_PathL_3,'AUC_PathL',Tail);
AUC_CLs_43{9,5} = CL_Pval(auc_Lambda_4_rand - auc_Lambda_3_rand, auc_Lambda_4 - auc_Lambda_3,'AUC_Lambda',Tail);
AUC_CLs_43{10,5} = CL_Pval(auc_Gamma_4_rand - auc_Gamma_3_rand, auc_Gamma_4 - auc_Gamma_3,'AUC_Gamma',Tail);
AUC_CLs_43{11,5} = CL_Pval(auc_Sigma_4_rand - auc_Sigma_3_rand, auc_Sigma_4 - auc_Sigma_3,'AUC_Sigma',Tail);
AUC_CLs_43{12,5} = CL_Pval(auc_MEdgeBetw_4_rand - auc_MEdgeBetw_3_rand, auc_MEdgeBetw_4 - auc_MEdgeBetw_3,'AUC_MEdgeBetw',Tail);
AUC_CLs_43{13,5} = CL_Pval(auc_MNodeBetw_4_rand - auc_MNodeBetw_3_rand, auc_MNodeBetw_4 - auc_MNodeBetw_3,'AUC_MNodeBetw',Tail);


[h crit_p adj_p]=fdr_bh(abs(cell2mat(AUC_CLs_43(:,5))));
AUC_CLs_43(:,6)=num2cell(adj_p);

AUC_CLs_43(2:14,1:6)=AUC_CLs_43(1:13,1:6);
AUC_CLs_43(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable_43.mat -v7 AUC_CLs_43
xlswrite('AUCresultsTable_43.xlsx',AUC_CLs_43)

cd ..
save AUC_CLs.mat -v7 AUC_CLs_21  AUC_CLs_32 AUC_CLs_31 AUC_CLs_41  AUC_CLs_42 AUC_CLs_43
cd ..