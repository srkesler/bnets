...
rand("seed",1001);% Added by Vikram Rao on 09/18/2018 in order to fix the seed and have consistent results
...
save NetMesPerDens_G1_vs_G2.mat -v7 Dens_1_rand MClust_1_rand MDeg_1_rand Trans_1_rand ...
...
save NetMesPerDens_G2_vs_G3.mat -v7 Dens_2_rand MClust_2_rand MDeg_2_rand Trans_2_rand ...
...
save NetMesPerDens_G1_vs_G3.mat -v7 Dens_1_rand MClust_1_rand MDeg_1_rand Trans_1_rand ...
    Assort_1_rand GEff_1_rand MLocEff_1_rand Mod_1_rand ModL_1_rand ...
    PathL_1_rand MNodeBetw_1_rand MEdgeBetw_1_rand Lambda_1_rand Gamma_1_rand ...
    Sigma_1_rand ...
    Dens_1 MClust_1 MDeg_1 Trans_1 Assort_1 GEff_1 MLocEff_1 ...
...
save NetMesPerDens_G1_vs_G4.mat -v7 Dens_1_rand MClust_1_rand MDeg_1_rand Trans_1_rand ...
    Assort_1_rand GEff_1_rand MLocEff_1_rand Mod_1_rand ModL_1_rand ...
    PathL_1_rand MNodeBetw_1_rand MEdgeBetw_1_rand Lambda_1_rand Gamma_1_rand ...
    Sigma_1_rand ...
    Dens_1 MClust_1 MDeg_1 Trans_1 Assort_1 GEff_1 MLocEff_1 ...
...
for i=1:Nperm
    fprintf('%-4s\n',['generating random network #' num2str(i) '...']);
    rand("seed",1000+i); % Added by Vikram Rao on 09/18/2018 in order to fix the seed and have consistent results
    Samp2=randsample(Sz2+Sz4,Sz2,'true');
    rand("seed",2000+i); % Added by Vikram Rao on 09/18/2018 in order to fix the seed and have consistent results
...
save NetMesPerDens_G2_vs_G4.mat -v7 Dens_2_rand MClust_2_rand MDeg_2_rand Trans_2_rand ...
    Assort_2_rand GEff_2_rand MLocEff_2_rand Mod_2_rand ModL_2_rand ...
    PathL_2_rand MNodeBetw_2_rand MEdgeBetw_2_rand Lambda_2_rand Gamma_2_rand ...
    Sigma_2_rand ...
    Dens_2 MClust_2 MDeg_2 Trans_2 Assort_2 GEff_2 MLocEff_2 ...
...
save NetMesPerDens_G3_vs_G4.mat -v7 Dens_3_rand MClust_3_rand MDeg_3_rand Trans_3_rand ...
    Assort_3_rand GEff_3_rand MLocEff_3_rand Mod_3_rand ModL_3_rand ...
    PathL_3_rand MNodeBetw_3_rand MEdgeBetw_3_rand Lambda_3_rand Gamma_3_rand ...
    Sigma_3_rand ...
