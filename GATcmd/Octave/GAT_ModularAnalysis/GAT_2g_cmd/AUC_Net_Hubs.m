...
save(['Net_Hubs_Degnorm_' Group1 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd1norm','-v7');
clear HubNames
...
save(['Net_Hubs_Betwnorm_' Group1 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd1norm','-v7');
...
save(['Net_Hubs_Clustnorm_' Group1 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd1norm','-v7');
...
save(['Net_Hubs_Deg_' Group1 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd1','-v7');
...
save(['Net_Hubs_Betw_' Group1 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd1','-v7');
...
save(['Net_Hubs_Clust_' Group1 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd1','-v7');
...
save(['Net_Hubs_Degnorm_' Group2 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd2norm','-v7');
clear HubNames
...
save(['Net_Hubs_Betwnorm_' Group2 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd2norm','-v7');
clear HubNames
...
save(['Net_Hubs_Clustnorm_' Group2 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd2norm','-v7');
clear HubNames
...
save(['Net_Hubs_Deg_' Group2 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd2','-v7');
...
save(['Net_Hubs_Betw_' Group2 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd2','-v7');
clear HubNames
...
save(['Net_Hubs_Clust_' Group2 '_' num2str(SD) 'SD.mat'],'HubNames','HubInd2','-v7');
clear HubNames
