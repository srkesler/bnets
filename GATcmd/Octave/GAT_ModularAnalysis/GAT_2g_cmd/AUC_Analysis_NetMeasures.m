...
AUC_indiv_mat(2:1+ff.mat4GAT.n1,1:17)=AUC_indiv_mat(1:ff.mat4GAT.n1,1:17);


AUC_indiv_mat(1,1:17) = {'Subj','Group','MClust','MDegree','Trans','Assort','Eglob','MEloc','Mod','PathL','Lambda','Gamma','Sigma','MEdgeBtwn','MNodeBtwn','Mmoddegzscore','Mpartcoeff'};
