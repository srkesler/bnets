function  ModularAnalysis_old(root, roifilename,mat4GATfilename,sparse,ngroups,nperm,Precision)
...
for i = 1:length(Com_g1) % Loop across each module
    ...
    if sparse==0
        NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0,8,100, 2, 0.05,connfile,mat4GAT.MinThr,mat4GAT.MaxThr,mat4GAT.MesStep,mat4GAT.g1,'none',mat4GAT.n1,0);
    elseif sparse==1
    ...
    cell2csv('HubSumary.csv',results)    
end
...
for i = 1:length(Com_g2)
    ...
    %% Run network measures with all subjects in 1st group and 0/none in the 2nd group
    if sparse==0
        NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0,8,100, 2, 0.05,connfile,mat4GAT.MinThr,mat4GAT.MaxThr,mat4GAT.MesStep,mat4GAT.g2,'none',mat4GAT.n2,0);
    elseif sparse==1
...
if ngroups>2
    for i = 1:length(Com_g3)
        ...
        %% Run network measures with all subjects in 1st group and 0/none in the 2nd group
        if sparse==0
            NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0,8,100, 2, 0.05,connfile,mat4GAT.MinThr,mat4GAT.MaxThr,mat4GAT.MesStep,mat4GAT.g3,'none',mat4GAT.n3,0);
        elseif sparse==1
...
if ngroups>3
    for i = 1:length(Com_g4)
        ...
        %% Run network measures with all subjects in 1st group and 0/none in the 2nd group
        if sparse==0
            NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0,8,100, 2, 0.05,connfile,mat4GAT.MinThr,mat4GAT.MaxThr,mat4GAT.MesStep,mat4GAT.g4,'none',mat4GAT.n4,0);
        elseif sparse==1
