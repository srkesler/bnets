function [N1,N2,N3,N_G1,N_G2,N_G3]=Rand_Net_Bootstrap_AcrossSbjComp(data_log,Data1_g1g2,Data2_g1g2,Data2_g2g3,Data3_g2g3, Data1_g1g3, Data3_g1g3,Nperm)
...
rand("seed",1001);% Added by Vikram Rao on 08/06/2018 in order to fix the seed and have consistent results
...
for i=1:Nperm
    ...
    rand("seed",1000+i); % Added by Vikram Rao on 08/06/2018 in order to fix the seed and have consistent results
    Samp1=randsample(Sz1+Sz2,Sz1,'true');
    rand("seed",2000+i); % Added by Vikram Rao on 08/06/2018 in order to fix the seed and have consistent results
