...
% This needs to be in your Octave path

% GAT-CMD requires statistics package from octave source forge
% (https://octave.sourceforge.io) and download the stats package by typing: pkg install -forge statistics 
% At the command prompt Type the following before using this script: ﻿pkg load statistics

% GAT-CMD copyright 2020 Vikram Rao and Shelli Kesler
% GAT-GUI copyright 2012 Hadi Hosseni and Shelli Kesler
% We are no longer supporting GAT-GUI
...
% USER EDIT HERE-----------------------------------------------------------------------------
GAT='/Users/Desktop/GATcmd'; %edit path
BCTpath='/Users/Desktop/GATcmd/2019_03_03_BCT'; %edit path

root='/Users/Desktop/Study/'; %% Folder containing connectivity data. This is where the results will be stored
cd(root)
...
regional=0; % Set to 1 if you want mass univariate regional analysis
...
switch ngroups
    ...
    case 2
        ...
        if sparse==0 % Functional or Structural data
            NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0, 8, 100, 2, 0.05,fullfile(root,connfile),minthr,maxthr,stepthr,g1,g2,n1,n2);
    ...
    case 3
        ...
        if sparse==0 % Functional or Structural data
            NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0,8, 100, 2, 0.05,fullfile(root,connfile),minthr,maxthr,stepthr,g1,g2,g3,n1,n2,n3);
        elseif sparse==1 % Diffusion Data
    ...
    case 4
        ...
        if sparse==0 % Functional or Structural data
            NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(0,8, 100, 1, 0.05,fullfile(root,connfile),minthr,maxthr,stepthr,g1,g2,g3,g4,n1,n2,n3,n4);
        elseif sparse==1 % Diffusion Data
