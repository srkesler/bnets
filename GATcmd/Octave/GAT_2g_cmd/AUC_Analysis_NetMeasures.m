...
AUC_CLs(2:14,1:6)=AUC_CLs(1:13,1:6);
AUC_CLs(1,1:6)={'measure','meandiff','LL','UL','pval','pFDR'};
save AUC_ResultsTable.mat -v7 AUC_CLs
xlswrite('AUCresultsTable.xlsx',AUC_CLs)
