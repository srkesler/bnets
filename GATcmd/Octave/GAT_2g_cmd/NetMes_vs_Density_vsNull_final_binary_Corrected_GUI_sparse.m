function NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_sparse(Null_Iter, Tail, Alpha, Precision, connfile,MinMes,MaxMes,MesStep,Group1,Group2,n1,n2) 
...
% % Alpha = input('significance threshfaold level (e.g. 0.05):  ');
mat4GAT.alpha = Alpha;
...
mat4GAT.roi1 = names;
mat4GAT.roi2 = names;
save(['mat4GAT_' Group1 '_' Group2 '.mat'],'mat4GAT');

Spare=NetMes_Bin;
NetMes_Bin=Spare(1:n1,:);save(['NetMesBin_' Group1 '_FinalThrRange.mat'],'NetMes_Bin','-v7');
NetMes_Bin=Spare(n1+1:n1+n2,:);save(['NetMesBin_' Group2 '_FinalThrRange.mat'],'NetMes_Bin','-v7');
NetMes_Bin=Spare;
