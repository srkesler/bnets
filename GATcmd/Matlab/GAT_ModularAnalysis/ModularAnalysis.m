...
if sparse==0
    NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(1,feature('numcores'),100, 2, 0.05,connfile,ff.mat4GAT.MinThr,ff.mat4GAT.MaxThr,ff.mat4GAT.MesStep,ff.mat4GAT.g1,'none',ff.mat4GAT.n1,0);
elseif sparse==1
...
% % % % %     AUC_Net_Hubs(data_log,Data1,Data2,1)
    ...
    writetable(cell2table(results),fullfile(root,'modularanalysis',ff.mat4GAT.g1,sprintf('module%d',i),'Regional','HubSummary.csv'),'writevariablenames',0)
end
...
save(connfile,'Z','names')
if sparse==0
    NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(1,feature('numcores'),100, 2, 0.05,connfile,ff.mat4GAT.MinThr,ff.mat4GAT.MaxThr,ff.mat4GAT.MesStep,ff.mat4GAT.g2,'none',ff.mat4GAT.n2,0);
elseif sparse==1
...
% % % %     AUC_Net_Hubs(data_log,Data1,Data2,1)
    ...
    writetable(cell2table(results),fullfile(root,'modularanalysis',ff.mat4GAT.g2,sprintf('module%d',i),'Regional','HubSummary.csv'),'writevariablenames',0);
end
...
if ngroups>2
    ...
    save(connfile,'Z','names')
    if sparse==0
        NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(1,feature('numcores'),100, 2, 0.05,connfile,ff.mat4GAT.MinThr,ff.mat4GAT.MaxThr,ff.mat4GAT.MesStep,ff.mat4GAT.g3,'none',ff.mat4GAT.n3,0);
    elseif sparse==1
...
% % %         AUC_Net_Hubs(data_log,Data1,Data2,1)
    ...
    writetable(cell2table(results),fullfile(root,'modularanalysis',ff.mat4GAT.g3,sprintf('module%d',i),'Regional','HubSummary.csv'),'writevariablenames',0);
    end
end
...
if ngroups>3
    ...
    save(connfile,'Z','names')
    if sparse==0
        NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_dense(1,feature('numcores'),100, 2, 0.05,connfile,ff.mat4GAT.MinThr,ff.mat4GAT.MaxThr,ff.mat4GAT.MesStep,ff.mat4GAT.g4,'none',ff.mat4GAT.n4,0);
    elseif sparse==1
    ...
    for i = 1:length(Com_g4)
        ...
        writetable(cell2table(results),fullfile(root,'modularanalysis',ff.mat4GAT.g4,sprintf('module%d',i),'Regional','HubSummary.csv'),'writevariablenames',0);
    end
end