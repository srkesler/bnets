function NetMes_vs_Density_vsNull_final_binary_Corrected_GUI_sparse(Null_Iter, Tail, Alpha, Precision, connfile,MinMes,MaxMes,MesStep,Group1,Group2, Group3,Group4, n1,n2,n3,n4)  
...
%           the NetMeasure values (default 0.01 for density)
...
save(['mat4GAT_' Group1 '_' Group2 '_' Group3 '_' Group4],'mat4GAT');
...
MinThr = MinMesPlot;MinIdx = 1;
MaxThr = MaxMesPlot;MaxIdx =  size(NetMes_Bin,2);
NetMes_Bin=NetMes_Bin(1:n1+n4,MinIdx:MaxIdx);

Spare=NetMes_Bin;
NetMes_Bin=Spare(1:n1,:);save(['NetMesBin_G1_vs_G4_' Group1 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin = Spare(n1+1:n1+n4,:);save(['NetMesBin_G1_vs_G4_' Group4 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin=Spare;
...
MinThr = MinMesPlot;MinIdx = 1;
MaxThr = MaxMesPlot;MaxIdx =  size(NetMes_Bin,2);
NetMes_Bin=NetMes_Bin(1:n2+n4,MinIdx:MaxIdx);

Spare=NetMes_Bin;
NetMes_Bin=Spare(1:n2,:);save(['NetMesBin_G2_vs_G4_' Group2 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin = Spare(n2+1:n2+n4,:);save(['NetMesBin_G2_vs_G4_' Group4 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin=Spare;
...
MinThr = MinMesPlot;MinIdx = 1;
MaxThr = MaxMesPlot;MaxIdx =  size(NetMes_Bin,2);
NetMes_Bin=NetMes_Bin(1:n3+n4,MinIdx:MaxIdx);

Spare=NetMes_Bin;
NetMes_Bin=Spare(1:n3,:);save(['NetMesBin_G3_vs_G4_' Group3 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin = Spare(n3+1:n3+n4,:);save(['NetMesBin_G3_vs_G4_' Group4 '_FinalThrRange'],'NetMes_Bin','-v7.3');
NetMes_Bin=Spare;
