...
save(['Indiv_NetMesReg_' Group4],'MClust_4norm','MDeg_4norm','MNodeBetw_4norm','MLocEff_4norm');
save(['Indiv_AUC_NetMesReg_' Group4],'AUC_MClust_4norm','AUC_MDeg_4norm','AUC_MNodeBetw_4norm','AUC_MLocEff_4norm');
save(['Indiv_fda_NetMesReg_' Group4],'fda_MClust_4norm','fda_MDeg_4norm','fda_MNodeBetw_4norm','fda_MLocEff_4norm');
...
save(['NetMesReg_rand_' Group1],'MClust_1_randnorm','MDeg_1_randnorm','MNodeBetw_1_randnorm','MLocEff_1_randnorm');
save(['NetMesReg_rand_' Group4],'MClust_4_randnorm','MDeg_4_randnorm','MNodeBetw_4_randnorm','MLocEff_4_randnorm');
save(['AUC_NetMesReg_rand_' Group1],'AUC_MClust_1_randnorm','AUC_MDeg_1_randnorm','AUC_MNodeBetw_1_randnorm','AUC_MLocEff_1_randnorm');
save(['AUC_NetMesReg_rand_' Group4],'AUC_MClust_4_randnorm','AUC_MDeg_4_randnorm','AUC_MNodeBetw_4_randnorm','AUC_MLocEff_4_randnorm');
save(['fda_NetMesReg_rand_' Group1],'fda_MClust_1_randnorm','fda_MDeg_1_randnorm','fda_MNodeBetw_1_randnorm','fda_MLocEff_1_randnorm');
save(['fda_NetMesReg_rand_' Group4],'fda_MClust_4_randnorm','fda_MDeg_4_randnorm','fda_MNodeBetw_4_randnorm','fda_MLocEff_4_randnorm');

save(['NetMesReg_' Group1],'MClust_1norm','MDeg_1norm','MNodeBetw_1norm','MLocEff_1norm');
save(['NetMesReg_' Group4],'MClust_4norm','MDeg_4norm','MNodeBetw_4norm','MLocEff_4norm');
save(['AUC_NetMesReg_' Group1],'AUC_MClust_1norm','AUC_MDeg_1norm','AUC_MNodeBetw_1norm','AUC_MLocEff_1norm');
save(['AUC_NetMesReg_' Group4],'AUC_MClust_4norm','AUC_MDeg_4norm','AUC_MNodeBetw_4norm','AUC_MLocEff_4norm');
save(['fda_NetMesReg_' Group1],'fda_MClust_1norm','fda_MDeg_1norm','fda_MNodeBetw_1norm','fda_MLocEff_1norm');
save(['fda_NetMesReg_' Group4],'fda_MClust_4norm','fda_MDeg_4norm','fda_MNodeBetw_4norm','fda_MLocEff_4norm');
